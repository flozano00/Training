            ...
            if (_logValidation(salesRep))
            {
                ...
                */
                ...
                //Change the Customer Record Type here as well.
                    var recordType = 'customrecord_vee_crecord_transaction1';
                    nlapiSubmitField(recordType, recInternalId, 'custrecord_vee_marktransaction_comission',comsionPercent);
                    nlapiSubmitField(recordType, recInternalId, 'custrecord_vee_marktransaction_percent', discountPercentage);
                    nlapiSubmitField(recordType, recInternalId, 'custrecord_vee_marktransaction_totalamo', total);
                } else {
                    ...
                    newCustomRecord.setFieldValue('custrecord_vee_marktransaction_percent', discountPercentage);//Setting Discount in new custom record Field: Discount ON Sales Order
